...
<div className="absolute pointer-events-none bottom-[-180px] left-[-120px] w-[620px] h-[620px] bg-purple-500/20 rounded-full blur-[200px]" />
      ...
      <div className="max-w-6xl mx-auto text-center mb-14 z-[1] relative">
        ...
        <p className="text-white/80 mt-4 max-w-2xl mx-auto">
          Sell or rent faster with verified buyers, smart tools, and maximum
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        ...
        {isLoggedIn && isAgent && <AgentDashboardCard user={user} />}
      </div>
    </section>
  );
}
...
function OwnerCard({ isLoggedIn }) {
  return (
    <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl px-6 py-8 shadow-2xl space-y-6">
...
function AgentDashboardCard({ user }) {
  ...
  return (
    <div className="bg-gradient-to-br from-emerald-600 to-teal-600 rounded-3xl p-8 shadow-2xl space-y-6">
      <h3 className="text-xl font-bold">You are a Verified Agent</h3>
