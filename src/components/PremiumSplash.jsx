...
//       <div className="absolute inset-0 bg-gradient-to-br from-indigo-900 via-black to-cyan-900 opacity-90" />

//       {/* ===== Floating Glow Orbs ===== */}
//       <div className="absolute w-[600px] h-[600px] bg-indigo-500/20 rounded-full blur-[140px] animate-orb1" />
//       <div className="absolute w-[500px] h-[500px] bg-cyan-400/20 rounded-full blur-[120px] animate-orb2" />
...
//         {/* Brand Name */}
//         <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight animate-logoReveal">
//           nestme<span className="text-indigo-400">.in</span>
//         </h1>

//         {/* Glass Tagline */}
//         <div className="mx-auto max-w-md backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl px-6 py-4 shadow-2xl animate-fadeUp delay-200">
      ...
      <div className="relative text-center px-6 space-y-4">
        ...
        <div className="flex justify-center animate-logoReveal">
          <img
            src="/splashlogo.png"
            alt="NestMe Logo"
            className="w-40 md:w-48 lg:w-56 drop-shadow-[0_0_40px_rgba(99,102,241,0.5)]"
          />
        </div>
