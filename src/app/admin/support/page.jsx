  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex-1 flex flex-col h-[650px] shadow-sm">
        <h2 className="p-3 font-semibold bg-gray-700 text-white text-center">
          Support Chat
        </h2>
        ...
        {!selected ? (
          ...
          <>
            {/* Messages */}
            <div className="flex-1 overflow-y-auto p-4 space-y-2 bg-gradient-to-br from-violet-200 to-pink-200">
